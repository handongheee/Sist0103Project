	...
	public void setDesign() {
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String sp = num1+"+"+num2+"="+sump;
				String sm = num1+"-"+num2+"="+summ;
				String sg = num1+"*"+num2+"="+sumg;
				String sn = num1+"/"+num2+"="+sumn;
				
			
				
				
				
				lblResult.setText(sp); // string 타입이 들어와야됨
				lblResult.setText(sm);
				lblResult.setText(sg);
				lblResult.setText(sn);
