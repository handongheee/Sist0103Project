...
<script type="text/javascript">
	function funcdel(num){
		...
		if(yes){ 
			location.href='deleteIntroduce.jsp?num='+num;
		}
	}
</script>
</head>
	...
	<table class="table table-bordered" style="width:600px;">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<button id="btndel" type="button" class="btn btn-danger" onclick="funcdel(<%=dto.getNum()%>)">삭제</button>
				<button type="button" class="btn btn-success" onclick="location.href='introduceList.jsp'">목록</button>
			</td>
		</tr>
