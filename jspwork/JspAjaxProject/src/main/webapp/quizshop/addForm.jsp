		...
		<table class="table table-bordered">
			<caption align="top"><b>상품등록</b></caption>
				<tr>
					...
					<td>
						<input type="text" name="sang_name" required="required" class="form-control" style="width:120px;">
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<button type="submit" class="btn btn-outline-success" onclick="location.href='shopList.jsp'">상품목록</button>
					</td>
				</tr>
		</table>
	</font>
