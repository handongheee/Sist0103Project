		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<td class="d-inline-flex">
					...
					<b>-</b>
					<input type="text" name="hp2" required="required" class="form-control" style="width:100px" onkeyup="goFocus(this)">
					<b>-</b>
			...
			<tr>
				...
				<td>
					<input type="date" name="birth" required="required" class="form-control" style="width:150px" value="2000-01-01">
				</td>
			</tr>
