...
<!-- 파일업로드 시, method="post" enctype="multipart/form-data" 는 필수 !!! -->
		...
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" style="width:100px;" class="btn btn-info btn-md" onclick="location.href='boardList.jsp'">목록으로</button>
				</td>
			</tr>
		</table>
	</form>
