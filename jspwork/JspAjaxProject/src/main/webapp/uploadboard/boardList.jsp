...
<body>
	<div style="margin:50px 100px; width:1000px;">
		...
		<button type="button" class="btn btn-warning" onclick="location.href='boardList02.jsp'">앨범형 목록</button> <br><br>
		...
		<table class="table table-hover">
			...
			<%
				for(int i=0; i<list.size(); i++){
					uploadBoardDto dto=list.get(i); // i번째 dto 얻기
					int no=list.size()-i; // 내림차순 넘버링
					%>
					<tr>
