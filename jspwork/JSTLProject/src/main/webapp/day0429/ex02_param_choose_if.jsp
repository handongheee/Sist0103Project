	...
	<c:if test="${!empty param.irum }">
		...
		<c:choose>
			...
			<c:when test="${param.nara=='호주'}">
				<h3 style="color:green;">호주 항공비는 110만원</h3>	
			</c:when>
			
			<c:otherwise>
				<h3 style="color:red;">${param.nara } 를 가는 항공편은 결항입니다.</h3>
			</c:otherwise>
		</c:choose>
	</c:if>
