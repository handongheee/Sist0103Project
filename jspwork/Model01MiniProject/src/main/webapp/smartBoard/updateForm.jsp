...
<form action="smartBoard/updateAction.jsp" method="post">
	...
	<caption align="top"><b>스마트게시판 수정</b></caption>
		...
		<tr>
			...
			<td>
				<input type="text" name="subject" class="form-control" required="required" style="width:500px;" value="<%=dto.getSubject()%>">
			</td>
		</tr>
		<!--  -->
		...
		<tr>
			<td colspan="2">
				<textarea name="content" id="content"		
					required="required"			
					style="width: 100%;height: 300px;d isplay: none;"><%=dto.getContent() %></textarea>				
			</td>
		</tr>
		<tr>
