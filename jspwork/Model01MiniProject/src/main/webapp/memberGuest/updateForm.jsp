...
<body>
	<div style="margin:50px 100px; width:600px;">
		...
		<!-- num, currentPage 히든으로, 페이징 처리 시 currentPage도 처리해줘야 됨! -->
			...
			<table class="table table-bodered">
				...
				<tr>
					...
					<td>
						...
						<!-- 이미지 미리보기 -->
						<img alt="" src="<%=(dto.getPhotoname()==null?"":"save/"+dto.getPhotoname()) %>" id="preshow" style="position: absolute; left:800px; top:100px; max-width:200px;">
					</td>
