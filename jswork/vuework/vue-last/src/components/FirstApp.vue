<template>
    <div>
        <h1 class="alert alert-info">FirstApp 입니다</h1>
        <h2>반응형 메세지</h2>
...
export default {
    setup() {
        ...
        const reactiveMessage = ref("Hello Reactive");
        const btnReactiveMessage = () => {
        ...
        const btnNormalMessage = () => {
            // 일반은 .value 안 붙여도 됨, 리액트나 ref는 value 필요
